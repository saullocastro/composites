...
0.5.14) [Computer software]. 2022. https://doi.org/10.5281/zenodo.2871782
...
Bibtex :
    ...
    @misc{composites2022,
        ...
        title = {{Methods to calculate composite plate properties (Version 0.5.14) [Computer software]. 2022}}
        }
